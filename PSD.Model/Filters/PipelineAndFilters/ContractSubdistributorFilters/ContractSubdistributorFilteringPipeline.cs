...
namespace PSD.Model.Filters.PipelineAndFilters.ContractSubdistributorFilters
{
    ...
    /// </summary>
    public class ContractSubdistributorFilteringPipeline : Pipeline<IQueryable<ContractSubdistributor>>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override IQueryable<ContractSubdistributor> Process(IQueryable<ContractSubdistributor> input)
        {
